...
# def cola_res(test_metrics):
#     return (test_metrics['eval_matthews_correlation'])
# def sst2_res(test_metrics):
#     return (test_metrics['eval_accuracy'])
# def stsb_res(test_metrics):
#     return (test_metrics['eval_averaged_scores'])
def extract_res(test_metrics,dataset_name):
    print(dataset_name)
